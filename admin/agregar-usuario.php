...
$userr = $_GET['usuario'];
 ?>
   <form class="login" action= "registro.php?email=<?php echo $email; ?>&username=<?php echo $userr; ?>" method="get">
       <h5 class="login-title">Crea un cuenta</h5>
       <label class="login-title">Nombre:</label>
       <input type="text" value="<?php echo $userr; ?>" class="login-input" readonly ><br>
