  ...
  <table>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><a href="modificando_tarea.php?fecha=<?php echo base64_encode($fecha); ?>&nombrec=<?php echo base64_encode($nombrec); ?>&nombreg=<?php echo base64_encode($nombreg); ?>&descripcion=<?php echo base64_encode($descripcion); ?>&idcurso=<?php echo base64_encode($idcurso); ?>">Modificar tarea</a></td>
      </tr>
      <?php
          }
        ?>
