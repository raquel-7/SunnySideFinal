...
<body>
  ...
  <div >
    <center>
    <h2 class = "bienvenido__tutor">Reportes bimestrales por alumno</h2>
    </center>
  </div>
<div >
  <center>
  <table>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><a href="ver_reporteB_maestro.php?idalumno=<?php echo base64_encode($idalumno); ?>&nombrea=<?php echo base64_encode($nombrea); ?>">Ver Reporte Bimestral</a></td>
      </tr>
      <?php
          }
        ?>
