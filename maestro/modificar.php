...
<body>
  ...
  <?php
    ...
    if (!$query) {
      echo "Ocurrió un error con query (Archivo: modificar.php, select evento).\n";
      exit;
    }
  ?>
  <center>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
         ...
         <td><a href="modificar_evento.php?fechahora=<?php echo $fechahora; ?>&descripcion=<?php echo $descripcion; ?>">Modificar evento</a></td>
      </tr>
      <?php
          }
        ?>
